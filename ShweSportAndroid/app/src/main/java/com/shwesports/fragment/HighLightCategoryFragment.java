...
import com.shwesports.adapter.GenreAdapter;
import com.shwesports.item.ItemGenre;
...
public class HighLightCategoryFragment extends Fragment {
        ...
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    HightLightFragment hightLightFragment = new HightLightFragment();
                    hightLightFragment.setArguments(bundle);
                    assert fm != null;
                    FragmentTransaction ft = fm.beginTransaction();
                    ft.hide(HighLightCategoryFragment.this);
                    ft.add(R.id.Container, hightLightFragment, genreName);
