...
import com.shwesports.adapter.MovieAdapter;
...
public class HightLightFragment extends Fragment {
    ...
    private void getMovieItem() {
        ...
        if (isLanguage) {
            jsObj.addProperty("method_name", "get_hightlight_by_lang_id");
            jsObj.addProperty("lang_id", Id);
        } else {
            jsObj.addProperty("method_name", "get_hightlight_by_gen_id");
