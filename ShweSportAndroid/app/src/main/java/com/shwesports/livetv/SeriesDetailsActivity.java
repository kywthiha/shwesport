...
import com.shwesports.adapter.CommentAdapter;
import com.shwesports.adapter.EpisodeAdapter;
import com.shwesports.adapter.HomeSeriesAdapter;
import com.shwesports.adapter.SeasonAdapter;
import com.shwesports.cast.Casty;
import com.shwesports.cast.MediaData;
import com.shwesports.db.DatabaseHelper;
import com.shwesports.dialog.DialogUtil;
import com.shwesports.dialog.RateDialog;
import com.shwesports.fragment.ChromecastScreenFragment;
import com.shwesports.fragment.EmbeddedImageFragment;
import com.shwesports.fragment.ExoPlayerFragment;
import com.shwesports.fragment.ReportFragment;
import com.shwesports.item.ItemComment;
import com.shwesports.item.ItemEpisode;
import com.shwesports.item.ItemSeason;
...
import com.shwesports.util.Events;
import com.shwesports.util.GlobalBus;
...
public class SeriesDetailsActivity extends BaseActivity implements RateDialog.RateDialogListener {
    ...
    MMTextView textTitle, textCategory, textRate, textReport, textRelViewAll, textComViewAll, textNoComment, textSeason, textNoEpisode, textSeasonDrop, textCount;
    ...
    private void displayData() {
        ...
        textCount.setText(MDetect.INSTANCE.getText(getString(R.string.count, NetworkUtils.viewFormat(Integer.parseInt(itemSeries.getTotalViews())))));
    ...
    private void showSeason(int position) {
        ...
        MMTextView textSeriesName = mDialog.findViewById(R.id.textSeasonName);
