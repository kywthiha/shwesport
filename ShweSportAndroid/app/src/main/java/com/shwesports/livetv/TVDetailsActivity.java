...
public class TVDetailsActivity extends BaseActivity implements RateDialog.RateDialogListener {
    ...
    MMTextView textTitle, textCategory, textRate, textReport, textRelViewAll, textComViewAll, textNoComment, textCount;
    ...
    private void displayData() {
        ...
        textTitle.setMMText(itemChannel.getChannelName());
        textCategory.setMMText(itemChannel.getChannelCategory());
        textRate.setMMText(itemChannel.getChannelAvgRate());
        ratingView.setRating(Float.parseFloat(itemChannel.getChannelAvgRate()));
        textCount.setMMText(getString(R.string.count, NetworkUtils.viewFormat(Integer.parseInt(itemChannel.getTotalViews()))));
