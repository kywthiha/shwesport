...
public class ItemChannel {
    ...
    public String getChannelName() {
        return MDetect.INSTANCE.getText(channelName);
    }
    ...
    public String getDescription() {
        return MDetect.INSTANCE.getText(channelDescription);
    }
    ...
    public String getChannelType() {
        return MDetect.INSTANCE.getText(channelType);
    }
    ...
    public String getChannelCategory() {
        return MDetect.INSTANCE.getText(channelCategory);
    }
    ...
    public String getTotalViews() {
        return MDetect.INSTANCE.getText(totalViews);
    }
    ...
    public String getChannelPoster() {
        return MDetect.INSTANCE.getText(channelPoster);
    }
