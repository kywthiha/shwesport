        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['cat_id'])){?>Edit<?php }else{?>Add<?php }?> League</div>
            </div>
          </div>
              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-md-3 control-label">League Name :-</label>
                    <div class="col-md-7">
                      <input type="text" name="genre_name" placeholder="Enter league name" id="genre_name" value="<?php if(isset($_GET['g_id'])){echo $row['genre_name'];}?>" class="form-control" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      	<?php if(isset($_GET['g_id']) and $row['genre_image']!="") {?>
                            <div class="block_wallpaper"><img src="images/<?php echo $row['genre_image'];?>" alt="League image"/></div>
                        <?php } ?>
                    </div>
                  </div><br>
                  <div class="form-group">
